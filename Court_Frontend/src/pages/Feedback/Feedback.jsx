...
const Feedback = () => {
  ...
  const fetchFeedback = async () => {
    try {
      ...
      const response = await axiosClient.get(`/feedback/${userId}`);
  ...
  return (
    <div className="w-full h-screen bg-gray-50 p-8">
      ...
      <FeedbackModal isOpen={isFeedbackModalOpen} onClose={() => setIsFeedbackModalOpen(false)} fetchFeedback={fetchFeedback} />
    </div>
  );
};
